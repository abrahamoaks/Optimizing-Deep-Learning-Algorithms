...
model.add(Dense(60, bias_initializer='normal', activation='relu', kernel_constraint=maxnorm(5)))
model.add(Dense(30, bias_initializer='normal', activation='relu', kernel_constraint=maxnorm(5)))
